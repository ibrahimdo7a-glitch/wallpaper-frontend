...
export async function generateMetadata({ params: { locale } }: Props): Promise<Metadata> {
  return {
    title: locale === 'ar' ? 'خلفيات الجوال - منصة الخلفيات' : 'Mobile Wallpapers - Wallpaper Platform',
  };
}

export default async function MobileWallpapersPage({ params: { locale }, searchParams }: Props) {
